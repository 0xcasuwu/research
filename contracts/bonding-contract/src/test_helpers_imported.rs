//! Test helpers imported from alkanes-rs
//!
//! This module contains test helpers imported directly from the alkanes-rs repository.
...
pub fn create_multiple_protomessage_from_edict_tx(
    ...
    let protostones = protocol_id
        .iter()
        .zip(protostone_edicts.iter())
        .enumerate()
        .map(|(i, (id, edicts))| Protostone {
            burn: None,
            edicts: edicts.clone(),
            pointer: Some(i as u32),
            refund: None,
