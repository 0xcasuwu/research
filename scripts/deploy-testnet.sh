...
# Deployment script for the bonding contract (testnet environment)
...
echo "Deploying bonding contract (testnet environment)..."
...
echo "alkanes deploy --wasm dist/bonding_contract.wasm --init-args \"0x424f4e44,0x424e44,100000,100000\""
echo ""
echo "The contract would be deployed with the following parameters:"
echo "  Name: BOND (0x424f4e44)"
echo "  Symbol: BND (0x424e44)"
echo "  Initial Supply: 100000"
echo "  Initial Reserve: 100000"
echo ""
